    ...
    return (
        <div className="rightheader">
            <div className="right_nav">
                {
                    username ?
                        <Avatar className="avtar2"
                             title={username[0].toUpperCase()}>{username[0].toUpperCase()}
                        </Avatar> :
                        <Avatar className="avtar"
                     />
                }
                {username ? <h3>Hello, {username.toUpperCase()}</h3> : ""}
            </div>
            <div className="nav_btn" onClick={()=>logclose()}>
                ...
                {
                    username ? <NavLink to="/buynow">Your Order</NavLink> : <NavLink to="/login">Your Order</NavLink>
                }
                <Divider style={{ width: "100%", marginLeft: -20 }} />
                <div className="flag">
